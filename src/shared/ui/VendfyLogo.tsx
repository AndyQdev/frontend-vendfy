 ...
 */
export const VendfyLogo = ({ variant = 'full', size = 40, className = '', dark = false }) => {
  // Icon only
  if (variant === 'icon' || variant === 'icon-dark') {
    const isDark = variant === 'icon-dark' || dark;
    const frameColor = isDark ? '#ffffff' : '#0F172A';
 ...
 */
export const VendfyIcon = ({ size = 32, className = '', dark = false }) => (
